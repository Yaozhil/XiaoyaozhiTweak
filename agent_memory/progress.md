...
- 版本号按用户规则递增，当前同步到 `1.1.2`，后续依次 `1.1.3`、`1.1.4`。
...
- 已同步 `control`、`README.md`、`Core/YZConfigManager.m`、`Core/YZPluginLifecycle.m`、`Guard/YZPrivacyGuard.m`、`preview.html` 到版本 `1.1.2`。
