...
- “猜丁壳+骰子”来源于 `ways0210/WechatEnhance` 的 `GameCheatsHook.xm` 思路，依赖微信 `CMessageMgr`、`CMessageWrap`、`GameController getMD5ByGameContent:` 等私有接口；不同微信版本可能变更游戏消息字段或 MD5 映射，需要真机验证。
