...
- 版本号按用户规则从 `1.0.8` 起递增，跳过 `1.1.0` 和 `1.1.4`；当前版本为 `1.1.5`。
...
- 用户提供成熟插件实际可跳转的公众号主页链接：`https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzYzOTc5MzgwNw==&scene=124`；底部胶囊失败兜底应优先使用该链接。
