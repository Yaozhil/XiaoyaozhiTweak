...
- 用户提供成熟插件实际可跳转的公众号主页链接：`https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzYzOTc5MzgwNw==&scene=124`；底部胶囊失败兜底应通过微信 `businessWebview` scheme 打开该链接，避免跳到 Safari。
